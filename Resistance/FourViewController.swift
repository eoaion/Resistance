...
//        case 1 : fallthrough
//        case 2 :
//            return self.colorValue.objectForKey(row) as! String
//        default :
//            return ""
//        }
//    }
    ...
    func pickerView(pickerView: UIPickerView, didSelectRow row: Int, inComponent component: Int) {
        ...
        if component == 2 {
            ...
            case 2:
                self.threeValue = 100
            case 3:
                self.threeValue = 1_000
            case 4:
                self.threeValue = 10_000
            case 5:
                self.threeValue = 100_000
            case 6:
                self.threeValue = 1_000_000
            case 7:
                self.threeValue = 10_000_000
            case 8:
                self.threeValue = 0.1
            case 9:
                self.threeValue = 0.01
            default:
                self.threeValue = 1
            }
        }
    ...
    func calculation() {
        var value = Double(self.firstValue * 10 + self.secondValue) * self.threeValue
